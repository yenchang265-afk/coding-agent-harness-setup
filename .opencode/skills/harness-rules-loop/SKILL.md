---
name: harness-rules-loop
description: Always-on global engineering standards (security hard rules, surgical changes, goal-driven execution, tests verify intent). Consult before writing or reviewing any code.
---
