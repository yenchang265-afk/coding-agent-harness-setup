...
function Install-Claude {
  ...
  Merge-McpJson (Join-Path $HOME '.claude.json') 'mcpServers' 'codegraph' @{ type = 'stdio'; command = 'codegraph'; args = @('serve', '--mcp') }
...
function Install-OpenCode {
  ...
  Merge-McpJson (Join-Path $base 'opencode.json') 'mcp' 'codegraph' @{ type = 'local'; command = @('codegraph', 'serve', '--mcp'); enabled = $true }
...
function Install-Antigravity {
  ...
  Merge-McpJson (Join-Path $base 'settings.json') 'mcpServers' 'codegraph' @{ command = 'codegraph'; args = @('serve', '--mcp') }
