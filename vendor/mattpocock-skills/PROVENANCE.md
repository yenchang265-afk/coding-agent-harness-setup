...
`.claude-plugin/plugin.json`, plus deprecated/in-progress/personal/misc skills
that the plugin manifest intentionally excludes.

To refresh: re-clone upstream, copy in, and update the commit/date above.
